...
{
    private static readonly Meter Meter = new("LupiraGeoApi.Depz");

    private static readonly Histogram<double> ProbeDuration =
        Meter.CreateHistogram<double>("geo.dependency.probe.duration", unit: "s");
    ...
    public static void ObserveUpFrom(DependencyReportCache cache) =>
        Meter.CreateObservableGauge("geo.dependency.up", () =>
